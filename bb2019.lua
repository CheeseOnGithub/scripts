...
local plantButton = autofarmTab.new("Button", {text="plant 5 plantboxes"})
...
while wait(0.1) do
    local Character = Players.LocalPlayer.Character
    if killauraToggle.on and Character:FindFirstChild("HumanoidRootPart") then
    ...
    if autohealToggle.on then
        if Character:FindFirstChild("Humanoid") and Character.Humanoid.Health <= autohealSlider.value then
